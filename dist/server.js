...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar express = __webpack_require__(/*! express */ \"express\");\nvar clientRouter_1 = __webpack_require__(/*! ./clientRouter */ \"./src/server/routes/clientRouter.ts\");\n//import categoryRouter from \"./categoryRouter\";\nvar router = express.Router();\nrouter.get(\"/test\", function (req, res, next) {\n    try {\n        res.status(200).json({ mst: \"Hello World!\" });\n    }\n    catch (error) {\n        next(error);\n    }\n});\nrouter.use(\"/Clients\", clientRouter_1.default);\n//router.use(\"/categories\", categoryRouter);\nexports.default = router;\n\n\n//# sourceURL=webpack://template2/./src/server/routes/index.ts?");
